      ...
      <div className="container relative z-10">
        <div className="max-w-3xl mx-auto text-center text-white">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm mb-6">
            ...
            <span className="text-sm text-white">2026학년도 동아리 모집 중</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-white/80 mb-8 max-w-2xl mx-auto">
            홍익대학교 총동아리연합회에서 운영하는 다양한 연합동아리를 만나보세요.
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              size="lg"
              className="bg-white text-primary border-2 border-white hover:bg-primary hover:text-white hover:border-primary transition-all"
              asChild
            >
